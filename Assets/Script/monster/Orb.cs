...
public class Orb : MonoBehaviour
{
    ...
    private bool wasInPreviousWorld;
    ...
    void Start()
    {
        ...
        wasInPreviousWorld = Inversion.IsInverted;
    ...
    void OnEnable()
    {
        Inversion.WorldChanged += HandleWorldChanged;
    }
    ...
    {
        return Inversion.IsInverted;
    }

    void HandleWorldChanged(bool isInverted)
    {
        wasInPreviousWorld = isInverted;
